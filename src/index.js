...
// Import the handlebars templates which register themselfs with a side effect
import './templates/flow';
        ...
        async (err, rn) => {
          try {
            ...
            if (type === 'wsdl') {
              ...
              const targetNsDefinition = Object.keys(rn.$)
                .find((nsDefinition) => nsDefinition.startsWith('xmlns:') && rn.$[nsDefinition].value === rn.$.targetNamespace.value);
            ...
            await fs.writeFile(`${file}.js`, prettier.format(result, {
              ...(await prettier.resolveConfig(`${file}.js`)),
              parser: 'babel',
            }), {
              charset: 'utf8',
            });
